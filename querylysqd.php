...
if (isset($_GET['submit'])) {
	$query_Recordset1 = "SELECT * FROM useapply WHERE month(date)='$_GET[cdate]' and year(date)='$year' ORDER BY date";
}
else{
$query_Recordset1 = "SELECT * FROM useapply where year(date)='$year' order by date";}
...
?>
  ...
  <a href="/phpweb/querylysqd.php">查看全部 </a>
</form>
